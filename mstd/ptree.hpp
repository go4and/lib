...
void dump_tree(std::ostream & out, const boost::property_tree::ptree & tree, int ident = 0);
void dump_tree(std::ostream & out, const boost::property_tree::wptree & tree, int ident = 0);
